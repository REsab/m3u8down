...
public class M3u8Main {
    ...
    public static final String C_M_3_U_8_JAVA_TEST_1 = "C://m3u8JavaTest1";
    private static final String
            M3U8URL = "https://cdn.extp.org/20200619/83970f6a35fa947359bbc9bcd382adeb.mp4/index.m3u8";

    public static void main(String[] args) {

        M3u8DownloadFactory.M3u8Download m3u8Download = M3u8DownloadFactory.getInstance(M3U8URL);
        //设置生成目录
        m3u8Download.setDir(C_M_3_U_8_JAVA_TEST_1);
        //设置视频名称
        m3u8Download.setFileName("test2");
        //设置线程数
