...
public class DownService {
    ...
    public void Down(DownloadFile down) {

        M3u8DownloadFactory.M3u8Download m3u8Download = M3u8DownloadFactory.getInstance(down.getUrlm3u8());
        //设置生成目录
        m3u8Download.setDir(down.getPath());
        //设置视频名称
        m3u8Download.setFileName(down.getFileName());
        //设置线程数
